...
| 이름            | 역할 및 담당                                                                                 |
|-----------------|--------------------------------------------------------------------------------------------|
| **손봉균(팀장)** | 풀스택 - 로그인, 회원가입, 실시간 채팅, 구글 소셜로그인, 페이징 처리, 게시판              |
| **이현진**      | 백엔드 - 마이페이지, 시큐리티, 네이버·카카오 소셜로그인, 댓글/대댓글, 공지 사항            |
| **박동영**      | 백엔드 - 레시피 페이지, 카테고리 구현, Gemini 챗봇, 이메일 인증                            |
| **정찬호**      | 백엔드 - 레시피 상세페이지, 쪽지 기능, 이미지 처리                                        |
---
